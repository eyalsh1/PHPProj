...
function EditAdmin($id)
{
    ...
    if ($_SESSION["role"] != "owner" && $admin['role'] === "owner") {
        $html .= "<div class=\"col-sm-12\">
                    <h2>Manager can not edit Owner!</h2>
                    <hr>
                  </div>
                </body>
            </html>";
...
{
    $html = "<select class=\"form-control\" name=\"role\" ";
    if ($_SESSION["role"] != "manager")
        $html .= "required><option></option>";
    else
        $html .= "disabled><option></option>";
